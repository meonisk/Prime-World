...
- `client/build (client), server/ (servers)` — बैटल हिस्से का संकलित क्लाइंट जिसमें चीट कोड्स और क्लाइंट एडिटर शामिल हैं
- `editor/build/PF_Editor.exe` — गेम डेटा एडिटर

## तैयारी
आपको इस रिपॉजिटरी से डेटा डाउनलोड करके `Bin` फोल्डर को मुख्य गेम डेटा के साथ मर्ज करना है। इसे करने का तरीका निम्नलिखित है:

1. `client/build/Bin` फोल्डर को `(legacy path, now split across engine/, client/, server/, editor/, assets/, localization/, profiles/, vendor/, tools/)` में कॉपी करें और मौजूदा फाइल्स को बदलें।
2. चीट कोड्स के साथ क्लाइंट चलाएं: `client/build/Bin/PW_Game.exe`।
...
अगर कोई त्रुटि हो, तो `logs/` में लॉग फाइल्स देखें।

## गेम डेटा
डेटा को एडिटर के ज़रिए संपादित किया जा सकता है, जिसका स्थान है `assets/`
...
## गेम डेटा एडिटर
गेम डेटा एडिटर `editor/build/PF_Editor.exe` पर स्थित है

एडिटर को पहली बार खोलते ही, आपको `Data` का पथ सेट करना होगा:
1. `Tools -> File System Configuration`
2. `Add -> WinFileSystem`
3. सिस्टम रूट के रूप में Data फोल्डर सेट करें: `assets/`
...
रिपॉजिटरी में आपको चीट कोड्स वाला संकलित गेम क्लाइंट मिल जाएगा — `client/build/Bin/PW_Game.exe`
